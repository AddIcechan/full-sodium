...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "ADDICE"
  # spec.authors            = { "ADDICE" => "addice.ch@gmail.com" }
...
#  spec.exclude_files = "Classes/Exclude"
  spec.vendored_frameworks  = "Sources/Clibsodium.xcframework"
  ...
  #
#  s.vendored_frameworks = 'Frameworks/YourFramework.xcframework'
